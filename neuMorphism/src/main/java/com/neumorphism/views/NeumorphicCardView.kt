...
import com.neumorphism.R
import com.neumorphism.ViewProperty
import com.neumorphism.utils.boundsRectF
...
class NeumorphicCardView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        isInDrawPhase = true
        canvas?.let {
            neumorphicPaint.color = neuBackgroundColor
            updateRect()
