package com.highenergymind.view.activity.imprint
...
import com.highenergymind.databinding.ActivityImPrintBinding
...
@AndroidEntryPoint
class ImPrintActivity : BaseActivity<ActivityImPrintBinding>() {
    val viewModel by viewModels<PageContentViewModel>()

    override fun getLayoutRes(): Int {
        return R.layout.activity_im_print
    }
    ...
    private fun setToolTitle() {
        binding.customTool.tvTitle.text = getString(R.string.imprint)
    }

    private fun getContent() {
        viewModel.apply {
            map.clear()
            map[ApiConstant.PAGE] = "imprint"
            getPageContent()
        }
    }
