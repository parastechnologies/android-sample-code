...
public class CircularSeekBar extends View {
    ...
    private static final int DEFAULT_CIRCLE_PROGRESS_BACKGROUND= Color.WHITE;
    private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(235, 74, 138, 255);
    private static final int DEFAULT_POINTER_COLOR = Color.argb(135, 233, 0, 248);
    private static final int DEFAULT_POINTER_HALO_COLOR = Color.argb(135, 233, 0, 248);
    private static final int DEFAULT_POINTER_HALO_COLOR_ONTOUCH = Color.argb(135, 233, 0, 248);
    ...
    private float mCircleStrokeWidthBackGround;
    ...
    private int mProgressBackGround = DEFAULT_CIRCLE_PROGRESS_BACKGROUND;
    private int mShadowColor = DEFAULT_POINTER_COLOR;
    ...
    private void initAttributes(TypedArray attrArray) {
        ...
        mCircleStrokeWidthBackGround = attrArray.getDimension(R.styleable.cs_CircularSeekBar_cs_circle_stroke_width_background, DEFAULT_CIRCLE_STROKE_WIDTH);
        ...
        mProgressBackGround = attrArray.getColor(R.styleable.cs_CircularSeekBar_cs_circle_progress_background, DEFAULT_CIRCLE_PROGRESS_BACKGROUND);
        mShadowColor = attrArray.getColor(R.styleable.cs_CircularSeekBar_cs_circle_shadow_color, DEFAULT_POINTER_COLOR);
    ...
    private void initPaints() {
        ...
        mCirclePaint.setStrokeWidth(mCircleStrokeWidthBackGround);
        mCirclePaint.setStyle(Paint.Style.STROKE);
        mCirclePaint.setStrokeJoin(Paint.Join.ROUND);
        mCirclePaint.setStrokeCap(mCircleStyle);
        mCirclePaint.setShadowLayer(10, 0, 0, mShadowColor);
...
//            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        float padding = Math.max(mCircleStrokeWidthBackGround / 2f,
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (mCircleStrokeWidthBackGround < minimumTouchTarget) { // If the width is less than the minimumTouchTarget, use the minimumTouchTarget
            additionalRadius = minimumTouchTarget / 2;
        }
        else {
            additionalRadius = mCircleStrokeWidthBackGround / 2; // Otherwise use the width
        }
