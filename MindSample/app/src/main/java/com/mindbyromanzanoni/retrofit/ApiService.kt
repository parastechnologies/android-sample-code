...
interface ApiService {
    ...
    suspend fun allTypeResponse(@Body map: HashMap<String, String>): Response<AllTypeCategoryDetail>
    ...
    /** Chat count Status Api*/
    @POST(ApiConstants.CHAT_COUNT)
    suspend fun chatCountApi(): Response<ChatCountResponseModel>
    ...
    suspend fun deleteUserApi(@Body hashmap: HashMap<String, String>): Response<CommonResponse>
}
