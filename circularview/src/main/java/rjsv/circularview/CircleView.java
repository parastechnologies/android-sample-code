...
public class CircleView extends View {
    ...
    private static int circlePadding = 10;
     ...
     */
    private float progressCurrentValue = 3;
    private float progressMinimumValue = 0;
    private float progressMaximumValue = 5;
    /**
    ...
    private boolean progressStepAsInteger = true;
    ...
    private boolean progressBarSquared = true;
...
//            String textTypeFacePath = a.getString(R.styleable.CircleView_textFont);
            String textTypeFacePath = "avenir_next_bold.otf";
...
//            textTypeFace = Typeface.createFromAsset(getResources().getAssets(), "avenir_black.otf");
