...
fun Activity.openAlertDeleteJournalData(callBack: () -> Unit) {
    val builder = AlertDialog.Builder(this, R.style.FullHeightDialog)
    val binding = SaveJournalDataDialogBinding.inflate(layoutInflater)
    builder.setView(binding.root)
    val alertDialog = builder.create()
    ...
    alertDialog.setCanceledOnTouchOutside(true)
    alertDialog.show()
    binding.title.text = getString(R.string.are_you_sure_you_want_to_delete_it)
    binding.btnSave.text = getString(R.string.okay)
    binding.btnCancel.setOnClickListener {
        alertDialog.dismiss()
    }
    binding.btnSave.setOnClickListener {
...
fun Activity.deleteAccount(callBack: () -> Unit) {
    val builder = AlertDialog.Builder(this, R.style.FullHeightDialog)
    val binding = SaveJournalDataDialogBinding.inflate(layoutInflater)
    builder.setView(binding.root)
    val alertDialog = builder.create()
    ...
    alertDialog.setCanceledOnTouchOutside(true)
    alertDialog.show()
    binding.title.text = getString(R.string.are_you_sure_you_want_to_delete_account)
    binding.btnSave.text = getString(R.string.okay)
    binding.btnCancel.setOnClickListener {
        alertDialog.dismiss()
    }
