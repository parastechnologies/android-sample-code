...
import com.highenergymind.databinding.ItemFavTrackBinding
...
class FavTrackAdapter(val isDescShow: Boolean = false) :
    ListAdapter<TrackOb, FavTrackAdapter.ViewHolder>(object :
    ...
    inner class ViewHolder(val binding: ItemFavTrackBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemFavTrackBinding.inflate(LayoutInflater.from(parent.context), parent, false)
