...
//            Log.e(com.outlet.sync.util.choosePhoto.LocalStorageProvider.class.getSimpleName(), "Error writing thumbnail", e);
            return null;
        } finally {
            if (out != null)
                try {
...
//                    Log.e(com.outlet.sync.util.choosePhoto.LocalStorageProvider.class.getSimpleName(), "Error closing thumbnail", e);
                }
        }
